...
const navByRole: Record<AppRole, NavGroup[]> = {
  superadmin: [
    ...
    { group: "Admissions & Academics", items: [
      ...
      { to: m("assessments"), label: "Quizzes, Tests & Exams", icon: CheckCircle2 },
      { to: m("submissions"), label: "Assignment Submissions", icon: ClipboardList },
      { to: m("gradesheet"), label: "Grade Sheet", icon: FileSpreadsheet },
      { to: m("reportcard"), label: "Report Cards", icon: Award },
    ...
    { group: "Website (CMS)", items: [
      ...
      { to: m("homepage"), label: "Homepage Sections", icon: ImageIcon },
      { to: m("projectspage"), label: "Projects Page", icon: FolderTree },
      { to: m("storiespage"), label: "Stories Page", icon: Newspaper },
      { to: m("divisionspage"), label: "Divisions Page", icon: FolderTree },
  ...
  teacher: [
    ...
    { group: "Teaching", items: [
      ...
      { to: m("submissions"), label: "Student Submissions", icon: ClipboardList },
      { to: m("assessments"), label: "Quizzes, Tests & Exams", icon: CheckCircle2 },
      { to: m("lessonplans"), label: "Lesson Plans", icon: BookOpen },
  ...
  student: [
    { group: "Today", items: [
      ...
      { to: m("timetable"), label: "Timetable", icon: Calendar },
      { to: m("assignments"), label: "Assignments", icon: ClipboardList },
      { to: m("submissions"), label: "My Submissions", icon: ClipboardList },
      { to: m("calendar"), label: "School Calendar", icon: Calendar },
    ]},
    { group: "Learning", items: [
      { to: m("classes"), label: "My Subjects", icon: BookOpen },
      { to: m("grades"), label: "Grades & Reports", icon: Award },
      { to: m("assessments"), label: "Quizzes & Tests", icon: CheckCircle2 },
      { to: m("gradesheet"), label: "My Grade Sheet", icon: FileSpreadsheet },
      { to: m("reportcard"), label: "My Report Card", icon: Award },
      { to: m("exams"), label: "Exams", icon: Award },
      { to: m("library"), label: "CK-12 Digital Library", icon: Library },
    ]},
  ...
  parent: [
    ...
    { group: "Academic Progress", items: [
      ...
      { to: m("gradesheet"), label: "Grade Sheet", icon: FileSpreadsheet },
      { to: m("reportcard"), label: "Report Card", icon: Award },
      { to: m("exams"), label: "Exams", icon: Award },
