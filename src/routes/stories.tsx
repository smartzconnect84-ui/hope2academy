...
const stories = [
  ...
  { img: school, tag: "Education", date: "January 18, 2026", read: "5 min", title: "Teacher training: 38 educators graduate from our literacy track", excerpt: "HOPE2-LIBERIA partnered with the Ministry of Education to deliver a six-week intensive on early literacy methods. Every graduate returns to their classroom this term.", author: "Grace Kollie", role: "Education Director", initials: "GK" },
];
